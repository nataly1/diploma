...
//    }
//
//    public void setIntegerAnswerOnQuestion(int numberOfQue, ArrayList<Integer> answers) {
//        answerStates[numberOfQue].setIntegerAnswer(answers);
//    }
//
//    public void setStringAnswerOnQuestion(int numberOfQue, ArrayList<String> answers) {
//        answerStates[numberOfQue].setStringAnswer(answers);
//    }
//
//    public ArrayList<Integer> getIntegerAnswerOnQuestion(int numberOfQue) {
//        return this.answerStates[numberOfQue].getSelectedIntegerAnswer();
//    }
//
//    public ArrayList<String> getStringAnswerOnQuestion(int numberOfQue) {
//        return this.answerStates[numberOfQue].getSelectedStringAnswer();
//    }
//
